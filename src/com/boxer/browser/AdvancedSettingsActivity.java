...
public class AdvancedSettingsActivity extends Activity {
	...
	private CheckBox cb1, cb2, cb3, cb4, cb5, cb6, cb7, cb8, cb9, cb10, cb11,
			cbIncognitoCookies, cbSearchSuggestions, cbClearHistoryExit,
			cbClearCookiesExit;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textView2.setTypeface(tfSemiBold);

		TextView textView13 = (TextView) findViewById(R.id.textView13);
		textView13.setTypeface(tfRegular);
		TextView textView3 = (TextView) findViewById(R.id.textView3);
		textView3.setTypeface(tfSemiBold);

		TextView tvClearHistory = (TextView) findViewById(R.id.tvClearHistory);
		tvClearHistory.setTypeface(tfSemiBold);
		TextView tvClearCookiesExit = (TextView) findViewById(R.id.tvClearCookiesExit);
		tvClearCookiesExit.setTypeface(tfSemiBold);

		TextView textView4 = (TextView) findViewById(R.id.textView4);
		textView4.setTypeface(tfSemiBold);

		TextView textView12 = (TextView) findViewById(R.id.textView12);
		textView12.setTypeface(tfRegular);

		TextView textView5 = (TextView) findViewById(R.id.textView5);
		textView5.setTypeface(tfSemiBold);

		TextView textView6 = (TextView) findViewById(R.id.textView6);
		textView6.setTypeface(tfSemiBold);
		TextView textView7 = (TextView) findViewById(R.id.textView7);
		textView7.setTypeface(tfSemiBold);
		TextView textView7Small = (TextView) findViewById(R.id.textView7Small);
		textView7Small.setTypeface(tfRegular);

		TextView textView8 = (TextView) findViewById(R.id.textView8);
		textView8.setTypeface(tfSemiBold);
		TextView textView8Small = (TextView) findViewById(R.id.textView8Small);
		textView8Small.setTypeface(tfRegular);

		TextView tvIncogCookie = (TextView) findViewById(R.id.tvIncogCookie);
		tvIncogCookie.setTypeface(tfSemiBold);

		TextView textView9 = (TextView) findViewById(R.id.textView9);
		textView9.setTypeface(tfSemiBold);
		TextView textView9Small = (TextView) findViewById(R.id.textView9Small);
		textView9Small.setTypeface(tfSemiBold);
		TextView textView10 = (TextView) findViewById(R.id.textView10);
		textView10.setTypeface(tfSemiBold);
		TextView textView10Small = (TextView) findViewById(R.id.textView10Small);
		textView10Small.setTypeface(tfSemiBold);
		TextView tvResotre = (TextView) findViewById(R.id.tvResotre);
		tvResotre.setTypeface(tfSemiBold);
		TextView tvfullScreenOption = (TextView) findViewById(R.id.tvfullScreenOption);
		tvfullScreenOption.setTypeface(tfSemiBold);

		TextView tvClearCache = (TextView) findViewById(R.id.tvClearCache);
		tvClearCache.setTypeface(tfSemiBold);
		TextView tvHistory = (TextView) findViewById(R.id.tvHistory);
		tvHistory.setTypeface(tfSemiBold);
		TextView tvClearBrwserCookie = (TextView) findViewById(R.id.tvClearBrwserCookie);
		tvClearBrwserCookie.setTypeface(tfSemiBold);
		TextView tvisImportAvailable = (TextView) findViewById(R.id.tvisImportAvailable);
		tvisImportAvailable.setTypeface(tfSemiBold);

		TextView tvisImportAvailableSub = (TextView) findViewById(R.id.tvisImportAvailableSub);
		tvisImportAvailableSub.setTypeface(tfRegular);

		TextView tvText = (TextView) findViewById(R.id.tvText);
		tvText.setTypeface(tfSemiBold);
	...
	private void initialize() {
		...
		TextView importBookmarks = (TextView) findViewById(R.id.tvisImportAvailableSub);
	...
	private void cbSearchSuggestions(CheckBox view) {
		view.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				mEditPrefs.putBoolean(
						PreferenceConstants.GOOGLE_SEARCH_SUGGESTIONS,
						isChecked);
				mEditPrefs.commit();
			}
	...
	private void r8(RelativeLayout view) {
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dialogClear.setContentView(R.layout.dialog_clear);
				...
				textViewMassage.setText(getResources().getString(
						R.string.dialog_history));
	...
	private void r10(RelativeLayout view) {
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				RadioButton radioSmallest = (RadioButton) dialogSearch
						.findViewById(R.id.radioSmallest);
				radioSmallest.setTypeface(tfPlain);
				...
				okbtn.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						if (lower.equalsIgnoreCase("Largest")) {
							which = 1;
						} else if (lower.equalsIgnoreCase("Large")) {
							which = 2;
						} else if (lower.equalsIgnoreCase("Normal")) {
							which = 3;
						} else if (lower.equalsIgnoreCase("Smallest")) {
							which = 5;
						} else if (lower.equalsIgnoreCase("Small")) {
							which = 4;
						}

						mEditPrefs.putInt(PreferenceConstants.TEXT_SIZE,
								which );
						mEditPrefs.commit();
...
//				picker.show();
	...
	public void importFromStockBrowser() {
		if (mSystemBrowser) {
			...
			Cursor mCur;
			mCur = getContentResolver().query(Browser.BOOKMARKS_URI, proj, sel,
					null, null);
			...
			if (mCur.moveToFirst() && mCur.getCount() > 0) {
				while (!mCur.isAfterLast()) {
					...
					if (title.length() < 1) {
						title = B_Utils.getDomainName(url);
					}
					B_Utils.addBookmark(mContext, title, url);
					mCur.moveToNext();
				}
			}
			B_Utils.showToast(mContext, number + " "
					+ getResources().getString(R.string.message_import));
		} else {
			B_Utils.createInformativeDialog(mContext,
