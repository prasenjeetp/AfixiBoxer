...
public class PrivecyAndPolicy extends Activity {
	WebView wv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progDailog = ProgressDialog.show(PrivecyAndPolicy.this, "Loading",
				"Please wait...", true);
		...
		wv.loadUrl("http://boxerinternet.com/privacy_policy.html");
