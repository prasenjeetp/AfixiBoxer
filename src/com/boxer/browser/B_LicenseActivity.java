...
import com.boxer.browser.R;import android.annotation.TargetApi;
...
public class B_LicenseActivity extends Activity implements View.OnClickListener {
	...
	private void actionView(String url) {
		startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(url), this, B_MainActivity.class));
		finish();
	}
